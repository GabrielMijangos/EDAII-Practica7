   ...
   for( int i = 0; i < g->len; ++i )
   {
      ...
      if( vertex->neighbors )
      {
              ...
              List_Cursor_next( vertex->neighbors ) )
         {
            ...
            printf( "%d( %d, %d)->", g->vertices[ neighbor_idx ].data,
                                     g->vertices[ neighbor_idx ].distance, 
                                     g->vertices[ neighbor_idx ].predecessor );
         }
      }
      printf( "Nil\n" );
...
int main()
{
   ...
   Graph_AddVertex( grafo, 700 );

   // crea las aristas (conexiones entre vértices):
   Graph_AddEdge( grafo, 100, 200 );
   Graph_AddEdge( grafo, 100, 400 );

   Graph_AddEdge( grafo, 200, 100 );
   Graph_AddEdge( grafo, 200, 300 );
   Graph_AddEdge( grafo, 200, 400 );
   Graph_AddEdge( grafo, 200, 500 );

   Graph_AddEdge( grafo, 300, 200 );
   Graph_AddEdge( grafo, 300, 500 );

   Graph_AddEdge( grafo, 400, 100 );
   Graph_AddEdge( grafo, 400, 200 );
   Graph_AddEdge( grafo, 400, 500 );
   Graph_AddEdge( grafo, 400, 600 );

   Graph_AddEdge( grafo, 500, 200 );
   Graph_AddEdge( grafo, 500, 300 );
   Graph_AddEdge( grafo, 500, 400 );
   Graph_AddEdge( grafo, 500, 600 );
   Graph_AddEdge( grafo, 500, 700 );

   Graph_AddEdge( grafo, 600, 400 );
   Graph_AddEdge( grafo, 600, 500 );
   Graph_AddEdge( grafo, 600, 700 );

   Graph_AddEdge( grafo, 700, 500 );
   Graph_AddEdge( grafo, 700, 600 );
